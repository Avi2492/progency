...
const OurTeam = () => {
  return (
    <>
      <div className="my-auto max-w-7xl px-2 lg:px-0 bg-base-200 md:h-screen md:my-6 flex flex-col items-center justify-center">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {Array.from({ length: 2 }).map((_, i) => (
            <div key={i} className="w-[300px] rounded-md border mx-auto">
              <img
