          ...
          <div className="mx-auto max-w-5xl">
            <div className="flex flex-wrap items-center">
              ...
              <div className="-mt-4 w-full lg:-mt-0 lg:w-1/3">
                <div className="pt-22 relative mx-auto max-w-sm rounded-lg bg-neutral px-10 pb-16 ">
                  ...
                  <div className="mt-7 border-t border-cyan-600 pt-5">
                    <ul className="mb-10">
                      <li className="mb-6 flex items-center">
              ...
              <div className="-mt-4 w-full lg:-ml-2 lg:-mt-0 lg:w-1/3">
                <div className="rounded-b-5xl lg:rounded-r-5xl mx-auto max-w-sm border border-gray-200 bg-base-content pb-8 pl-8 pr-5 pt-12 lg:rounded-b-none lg:pt-6">
                  <span className="mb-2 block text-sm font-semibold text-base-200">
                    PREMIUM
                  </span>
                  <span className="flex items-end">
